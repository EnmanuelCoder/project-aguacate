...
const UserOpinions = ({ nombre, pais, mensaje, foto }) => {
  return (
    <article className="px-10 relative w-full h-full flex items-center justify-center bg-primary text-white">
      <figure className="hidden px-2 md:w-1/2 md:order-1 md:flex md:justify-center">
      ...
      <div className="w-96 md:w-full lg:w-1/2  font-bold font-roboto border-b-4 border-indigo-500 ">
