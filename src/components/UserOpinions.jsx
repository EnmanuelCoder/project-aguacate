...
const UserOpinions = ({nombre, pais, mensaje, foto}) => {
  return (
    <article className="relative w-full h-full flex items-center justify-center  bg-colors-slate-200 ">
      ...
      <div className="w-80 md:w-full lg:w-1/2 px-3 font-bold font-roboto">
